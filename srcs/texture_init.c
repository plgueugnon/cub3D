...
/*   Updated: 2021/03/04 12:00:00 by pgueugno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_init_textures(t_data *data)
{
	data->texdata[0].img = mlx_xpm_file_to_image(data->i.mlx,
			data->p.no_tex_path, &(data->texdata[0].width),
			&(data->texdata[0].height));
	data->texdata[1].img = mlx_xpm_file_to_image(data->i.mlx,
			data->p.so_tex_path, &(data->texdata[1].width),
			&(data->texdata[1].height));
	data->texdata[2].img = mlx_xpm_file_to_image(data->i.mlx,
			data->p.ea_tex_path, &(data->texdata[2].width),
			&(data->texdata[2].height));
	data->texdata[3].img = mlx_xpm_file_to_image(data->i.mlx,
			data->p.we_tex_path, &(data->texdata[3].width),
			&(data->texdata[3].height));
	data->texdata[4].img = mlx_xpm_file_to_image(data->i.mlx,
			data->p.sp_tex_path, &(data->texdata[4].width),
			&(data->texdata[4].height));
